...
//pose atau emoticon
     	case 't': //tonjok (pose kyk genggam)
		    reset();
		    f1a=120; f1b=90;  f1c=60;
		    f2a=120; f2b=90;  f2c=60;
		    f3a=120; f3b=90;  f3c=60;
		    f4a=120; f4b=90;  f4c=60;
		    f5a=250; f5b=200; f5c=150;
		    break;
        ...
        case 'p':
		    reset();
		    f1a=120; f1b=96;  f1c=72;
		    f2a=130; f2b=104; f2c=78;
		    f3a=10;  f3b=8;   f3c=6;
		    f4a=0;   f4b=0;   f4c=0;
		    f5a=250; f5b=200; f5c=150;
    		break;
    		
        case 'g': //gun (pose gaya tembak)
            reset();
            f1a=125; f1b=100; f1c=75;
            f2a=135; f2b=108; f2c=81;
            f3a=0;   f3b=0;   f3c=0;
            f4a=0;   f4b=0;   f4c=0;
            f5a=0;   f5b=0;   f5c=0;
            break;
