// Pertemuan 3 - Keaktifan - Emoticon
...
void setGesture(int g){
    ...
    switch(g){
        case 1: // Angka 7 (jempol & telunjuk)
            f1_1=200; f1_2=160; f1_3=120;
            f2_1=200; f2_2=160; f2_3=120;
            f3_1=200; f3_2=160; f3_3=120;
            break;

        case 2: // Peace
            f5_1=150; f5_2=120; f5_3=90;
            f1_1=200; f1_2=160; f1_3=120;
            f2_1=200; f2_2=160; f2_3=120;
            break;
        ...
        case 4: // Genggam
            f1_1=125; f1_2=100; f1_3=75;
            f2_1=125; f2_2=100; f2_3=75;
            f3_1=125; f3_2=100; f3_3=75;
            f4_1=125; f4_2=100; f4_3=75;
            f5_1=125; f5_2=100; f5_3=75;
            break;
    }
}
...
void Keyboard(unsigned char key, int x, int y) {
	...
	case 'm': setGesture(1); break; 
    case 'n': setGesture(2); break; 
    case 'b': setGesture(3); break; 
    case 'v': setGesture(4); break;
